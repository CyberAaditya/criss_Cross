function start()
{
         ...
         tic_tac_toe.declare_human_win = function() {alert('Congrats !..You win')};

         tic_tac_toe.declare_computer_win = function() {alert('Cyberaditya Win')};

         tic_tac_toe.declare_tie = function() {alert('tie');};
